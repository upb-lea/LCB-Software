...
// Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 202)). Somit führen die Ausgänge
// OUT0, OUT8, OUT16 und OUT24 dasselbe Signal.
//
...
void main(void)
{
    ...
    // (siehe S. 283 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022
    ...
    // aktiviert werden (siehe S. 1176 Reference Manual TMS320F2838x, SPRUII0D, Rev. D,
    // July 2022). Da in der Funktion "DeviceInit" der Vorteiler PERCLKDIVSEL.EPWMCLKDIV
    // auf 2 gesetzt und SYSCLK 200 MHz beträgt ist sichergestellt, dass die Anforderungen
    // erfüllt sind.
    ...
    */
    ...
    // TMS320F2838x, SPRUII0D, Rev. D, July 2022)
    ...
    // ff. bzw. S. 1185 ff. Reference Manual TMS320F2838x, SPRUII0D, Rev. D,
    // July 2022)
    ...
    // Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022). Die
    // erste Spalte der Tabelle 17-4 gibt an, welcher Multiplexer (0 ... 15)
    // für das gewünschte Signal verwendet werden muss. Dabei ist darauf
    // zu achten, dass jedes CLB-Signal (AUXSIGn) einen entsprechenden
    // Multiplexer hat. Die oberste Zeile der Tabelle gibt den Registerwert
    // für den entsprechenden Multiplexer an. INPUT1 der Input X-Bar auf
    // den AUXSIG0-Ausgang legen
    ...
    // werden (siehe S. 2148  ff. Reference Manual TMS320F2838x, SPRUII0D,
    // Rev. D, July 2022). Die erste Spalte der Tabelle 17-5 gibt an, welcher
    // Multiplexer für das gewünschte Signal verwendet werden muss. Nach
    // Tabelle 15-7 (S. 1645 Reference Manual TMS320F2838x, SPRUII0D, Rev. D,
    // July 2022) kann auf GPIO 2 nur der Ausgang 1 der Output X-Bar gelegt
    // werden. Daher wird dieser im Folgenden konfiguriert.
