							...
							uint32_t signalMode)
{
    ...
    // Robin" steht (siehe S. 2532 Reference Manual TMS320F2838x, SPRUII0D,
    // Rev. D, July 2022). Falls immer die selben SOCs und diese immer zum
    // selben Zeitpunkt getriggert werden sowie der Pointer vor dem ersten
    // Triggern auf 16 steht (nach einem Reset der Fall), wir die SOC mit
    // der kleinsten Nummer zuerst durchgeführt und anschließend die
    // folgenden SOCs aufsteigend.
    // SOC0 konfigurieren:
    ...
    // ADC-Interrupt auslösen, nachdem der Wert in das Result-Register geschrieben
    // wurde (siehe S. 2536 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
    ...
    // (siehe S. 2536 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
