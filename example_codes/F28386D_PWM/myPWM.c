...
void PwmInitPwm123(void)
{
    ...
    EPwm1Regs.ETSEL.bit.INTEN = PWM_ET_INT_ENABLE;
    ...
    EPwm1Regs.ETPS.bit.INTPRD = PWM_ET_1ST;
		...
		// Die Umschaltung der CPU ist Glitch-behaftet. Daher sollte der Takt zu
    // der entsprechenden Peripherie erst nach der Zuweisung der steuernden CPU
    // durchgeschaltet werden (siehe S. 428 ff. Reference Manual TMS320F2838x,
    ...
    // INT3.1-Interrupt freischalten (Zeile 3, Spalte 1 der Tabelle 3-2)
