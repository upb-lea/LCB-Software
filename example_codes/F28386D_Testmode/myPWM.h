...
// Event-Interrupt ein-/ausschalten
#define PWM_ET_INT_DISABLE									0
#define PWM_ET_INT_ENABLE										1
...
// Endwert des Zählers zum Blinken der LEDs auf dem Control-Board
#define PWM_FINAL_COUNTER_LEDS							250
...
extern uint16_t counterToggleLeds;


//-------------------------------------------------------------------------------------------------
// Prototypes of global functions
//-------------------------------------------------------------------------------------------------
// Funktion initialisiert das ePWM1-, ePWM2-, ePWM3- und ePWM4-Modul um vier
// LEDs auf dem Docking-Board anzusteuern und über das Tastverhältnis zu dimmen
extern void PwmInitPWM1To4(void);
// Funktion initialisiert das ePWM8-Modul um alle 10 ms einen
