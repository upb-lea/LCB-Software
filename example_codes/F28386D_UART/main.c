...
///
///						Änderung myUART.c V2.0 : Verwendung der Hardware-Puffer zum Senden und Empfangen
///
/// @version	V1.2
///
/// @date			09.09.2022
...
void main(void)
{
    ...
    // 3) Funktion "UartReceive(n, TO)" aufrufen, n = Anzhal der zu sendenen Bytes, TO = Time-Out in 5 ms
