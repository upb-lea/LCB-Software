...
void PwmInitPwm8(void)
{
    ...
    // Takt für das PWM8-Modul einschalten und 5 Takte warten, bis der Takt zum
...
//=== Function: Epwm8ISR ==========================================================================
///
/// @brief  ISR wird alle 5 ms aufgerufen. Wird als Zeitgeber für den Aufruf der Funktion
///					"UartGetStatusRxA()" verwendet. Diese Funktion überwacht den Empfang von UART-Daten
///
/// @param  void
///
/// @return void
