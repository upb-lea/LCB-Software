...
void AD5664Init(uint32_t clock)
{
    ...
    // (siehe S. 1648 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
...
///
/// @brief  Funktion setzt den Wert für einen Kanal (A, B, C oder D) des DAC.
///					Der Wert wird vom DAC anschließend direkt übernommen
///
										 ...
										 uint16_t value)
{
		...
		// Daten in den SPI-Hardware-Puffer kopieren (16 Byte, Daten müssen links-bünig sein,
