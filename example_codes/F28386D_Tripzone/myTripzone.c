...
void TripzoneInitCmpss1(void)
{
    ...
    // (siehe S. 169 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
		...
		// legen (siehe S. 2745 Reference Manual TMS320F2838x, SPRUII0D,
		// Rev. D, July 2022)
		...
		// "Other Sources" (siehe S. 2142 Reference Manual TMS320F2838x, SPRUII0D,
		// Rev. D, July 2022). Quellen für die Output und ePWM X-Bar sind Trip 4,
		// 5, 7, 8, 9, 10, 11, 12 (Trip 1, 2, 3, 6 gehen direkt in die ePWM-Module).
    // Die ePWM X-Bar hat 8 Ausgänge, die jeweils bis zu 32 Signale führen können.
		// Jeder der 32 Multiplexer (MUX0 ... MUX31) kann aus bis zu 4 Signalen wählen.
		// Je nach gewünschtem Signal muss der entsprechende Multiplexer ausgewählt
		// werden. Anschließend muss das Ausgangssignal des Multiplexers noch durchge-
		// schleift werden. Optional kann das aus den 32 Signalquellen veroderte Gesamt-
		// signal noch invertiert werden (siehe S. 2144 Reference Manual TMS320F2838x,
		// SPRUII0D, Rev. D, July 2022).
		...
		// 0: Signalquelle gesperrt
		// 1: Signalquelle freigegeben
		...
		// (siehe S. 2917 Reference Manual TMS320F2838x,SPRUII0D, Rev. D, July 2022)
		...
		// Ungefiltertes/originales DCAEVT1-Signal für die weitere Verarbeitung verwenden
		// (siehe S. 2921 + 2922 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
		...
		// EPWM1-TZ-Interrupt freischalten (Zeile 2, Spalte 1 der Tabelle 3-2)
		...
		*/
		...
		// (siehe S. 2921 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022)
		...
		// Der Pegel am PWM-Ausgangspin des Mikrocontrollers wird durch vier Signale bestimmt
		// (siehe S. 2910 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022):
		// 1: TZx (Cycle-by-Cycle und One-Shot Trip Events)
		// 2: DCxEVENT1
		// 3: DCxEVENT2
		// 4: EPWMx
		// Die höchste Priorität hat das erste Signal (1), die kleinste das letzte (4)
		// (siehe S. 2920 Reference Manual TMS320F2838x, SPRUII0D, Rev. D, July 2022,
		// force signal). Jedes Signal mit einer höheren Priotität übersteuert Signale
		// mit einer niedrigeren Priorität. Das Signal EPWMxA/B wird durch die Konfiguration
		// des Timers etc. bestimmt und stellt das eigendliche PWM-Signal dar. Dieses kann
		// von Tripzone-Signalen übersteuert werden (typischerweise im Fehlerfall um in einen
		// sicheren Zustand zu wechseln). Das Verhalten der PWM-Pins durch die Tripzone-Signale
		...
		*/
		...
		// Mode Control Logic S. 2910 Reference Manual TMS320F2838x, SPRUII0D, Rev. D,
		// July 2022). Dieser Betrieb (One-Shot-Trip) übersteuert die Signale DCxEVT1.force
		// und DCxEVT2.force. Die Flags der DCxEVT1- und DCxEVT2 werden ebenfalls gesetzt
		// und müssen manuell gelöscht werden.
